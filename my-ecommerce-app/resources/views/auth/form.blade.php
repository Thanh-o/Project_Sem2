            ...
            <div class="signIn-signUp">
                <form action="{{ route('signin') }}" method="POST" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <i class="bx fa-fw bx-hide field-icon click-eye" toggle="#myInput"></i>
                    </div>
                ...
                <form action="{{ route('signup') }}" method="POST" class="sign-up-form">
                    ...
                    <div class="input-field">
                        <i class='bx bx-lock-alt'></i>
                        <input id="myInput" type="password" name="password_confirmation" placeholder="Confirm Password" required>
                        <i class="bx fa-fw bx-hide field-icon click-eye" toggle="#myInput"></i>
                    </div>
